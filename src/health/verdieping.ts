 ...
 * is ongeveer 45 procent van het verlies vetvrije massa" als vaste tekst mag.
...
export const VERDIEPINGEN: readonly Verdieping[] = [
  {
    ...
    weten: [
      ...
      'Medicatie staat een trede hóger, en dat is het punt dat het vaakst misgaat. De tekst in '
        ...
        + 'Nederlandse huisarts mag starten. De herziene NHG-Standaard Obesitas van oktober 2025 '
        + 'vraagt een aanzienlijk hogere BMI, mét gewichtsgerelateerde aandoeningen, én dat je '
        + 'eerst minstens een jaar gemotiveerd aan een leefstijlprogramma hebt meegedaan zonder '
    ...
    nietWeten: [
      'In dit stuk staan met opzet geen exacte BMI-grenzen. De criteria hierboven komen uit '
        + 'samenvattingen van de NHG-Standaard en niet uit de standaard zelf — genoeg om de '
        + 'volgorde uit te leggen, niet genoeg om een getal op te schrijven waar iemand zijn '
        + 'verwachting op bouwt. Je huisarts heeft de standaard wel.',
    ...
    bron: 'NHG-Standaard Obesitas 2.0 (13 oktober 2025), via samenvattingen; RIVM over de '
  ...
  },
  {
    ...
    weten: [
      ...
      'Bij de erkende middelen voor gewichtsbehandeling is in onderzoek gemiddeld 15 tot ruim 20 '
        + 'procent gewichtsverlies gezien over anderhalf jaar, met leefstijlbegeleiding erbij.',
    ],
    nietWeten: [
  ...
  },
  {
    ...
    weten: [
      ...
      'Van het oorspronkelijke verlies van ruim 17 procent bleef netto 5,6 procent over. Van de '
        + 'deelnemers hield nog ongeveer 43 procent minstens 5 procent verlies vast, en ongeveer '
        + '24 procent minstens 10 procent. Bijna één op de zes zat op of boven het startgewicht.',
  ...
  },
  {
    ...
    kort: 'Bij semaglutide was ongeveer 45 procent van het verlies vetvrije massa. Daar valt iets aan te doen.',
    weten: [
      'Een weegschaal telt kilo’s en zegt niet waar ze vandaan komen. In de '
        + 'lichaamssamenstellingsstudie bij STEP-1 was ongeveer 45 procent van wat er verdween '
  ...
  },
  {
    ...
    weten: [
      'Snel gewichtsverlies kost botdichtheid — dat geldt voor elke manier van afvallen, ook '
      ...
      'Over GLP-1 daarbovenop spreken de onderzoeken elkaar tegen. In één studie verlaagde een '
        ...
        + 'meeging. Een samenvattend onderzoek bij mensen met diabetes type 2 vond juist een '
        + 'verbetering.',
