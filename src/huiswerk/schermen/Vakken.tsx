 ...
 *
 * Alles wat een kind nodig heeft om te kiezen wat het gaat doen: de rang, de
 * weektaak van de ouder, de dagmissie, het dagdoel, wat er vandaag verdiend is,
 * en dan de vakken met hun onderwerpen.
 *
 * De volgorde is niet willekeurig. Bovenaan staat wat er al bereikt is, daarna
 * wat er vandaag te halen valt, en pas onderaan de lijst met onderwerpen — een
 * kind dat de app opent hoort eerst te zien dat het ergens staat, en dan pas
 * hoeveel er nog te doen is.
 */
...
export function Vakken(p: VakkenProps): ReactNode {
  ...
  return (
    <div>
      ...
      <h1 style={{ fontSize: 26 }}>{P.emoji} {P.naam}</h1>
      ...
      {weekrijen.length > 0 && (
        <div className="card" style={{ marginTop: 12, background: '#eef6ff', borderLeftColor: '#3a6ea0' }}>
      ...
      <div className="card" style={{ marginTop: 12, background: missie.klaar ? '#eaf7e2' : '#fff' }}>
        <div className="row" style={{ justifyContent: 'space-between' }}>
      ...
      <div className="card" style={{ marginTop: 12, background: doelGehaald ? '#eaf7e2' : '#fff' }}>
        <div className="row" style={{ justifyContent: 'space-between' }}>
          <b>
            🎯 Dagdoel
            {doelGehaald ? (p.thema.doel === 'doelpunten' ? ' — gehaald! ⚽' : ' — gehaald! 🎉') : ''}
          </b>
          <span className="muted" style={{ fontSize: 13 }}>
            {p.prog.todayCount || 0} / {doel} {p.thema.doel}
          </span>
        </div>
        <div className="pbar" style={{ marginTop: 8 }}><i style={{ width: doelPct + '%' }} /></div>
        <div className="wrap" style={{ marginTop: 10, alignItems: 'center' }}>
          <span className="muted" style={{ fontSize: 13 }}>Doel aanpassen:</span>
          <button
      ...
      {b && (
        <div
          className="card"
          style={{
            marginTop: 12, background: 'linear-gradient(135deg,#fff9e6,#fff4d1)',
      ...
      {heeftVolgend && (
        <div className="wrap" style={{ margin: '14px 0 0', alignItems: 'center' }}>
      ...
      <div className="wrap" style={{ margin: '14px 0 16px' }}>
        {P.vakken.map((v) => (
          <button
