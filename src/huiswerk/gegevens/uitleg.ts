...
export const UITLEG: Record<string, Uitlegstuk> = {
  ...
  'Machten vermenigvuldigen':{tekst:'Hebben twee machten hetzelfde grondtal, dan tel je bij vermenigvuldigen de exponenten op: a³ · a² = a⁵. Het grondtal blijft staan. Staan er getallen voor, dan gaan die gewoon keer elkaar: 3a⁵ · 4a³ = 12a⁸. Verschillen de grondtallen, dan mag je niets optellen: 2a³ · 5b⁴ = 10a³b⁴. Typ een macht als a5; een dakje mag ook (a^5).'},
  'Gelijksoortige termen':{tekst:'Twee termen zijn gelijksoortig als ze dezelfde letter met dezelfde exponent hebben. Alleen die mag je samennemen: 2a³ + 4a³ = 6a³. Bij 2a⁵ + 3a⁶ lukt dat niet, want de exponenten verschillen. Let op het verschil met keer: a⁵ + a⁵ = 2a⁵, maar a⁵ · a⁵ = a¹⁰. Typ een macht als a5; een dakje mag ook (a^5).'},
  'Macht van een macht':{tekst:'Staat er een macht van een macht, dan vermenigvuldig je de exponenten: (a²)³ = a⁶, want 2 × 3 = 6. Niet optellen. Een getal vóór de haakjes doet niet mee in de macht: 5(a³)⁶ = 5a¹⁸. Typ een macht als a5; een dakje mag ook (a^5).'},
  'Macht van een product':{tekst:'Bij een macht van een product krijgt elke factor die macht: (ab)⁵ = a⁵b⁵ en (5x)³ = 125x³. Het getal gaat dus mee. Een minteken binnen de haakjes gaat ook mee: (−3p)³ = −27p³, maar (−2q)⁴ = 16q⁴, want een even exponent maakt er een plus van. Staat het minteken buiten de haakjes, dan blijft het buiten. Typ een macht als a5; een dakje mag ook (a^5).'},
  'Machten delen':{tekst:'Bij delen trek je de exponenten van elkaar af: a¹² ÷ a⁷ = a⁵. De getallen deel je gewoon: 12a¹⁰ ÷ 4a² = 3a⁸. Boven en onder hetzelfde geeft 1, en daarom is a⁰ = 1. Typ een macht als a5; een dakje mag ook (a^5).'},
