...
| `npm run gouden-waarden` | Genereert de gouden waarden opnieuw uit de oude code: de rekenkern, de herhalingsplanner, de kaartplanner van Geloofsstudie en de Python-vertaler van Computers & Code. Alleen nodig als die veranderen, en dat hoort niet te gebeuren. |
...
const OMGEBOUWD = ['start', 'health', 'spellen', 'rasikh', 'sanad', 'bunyan']
```
