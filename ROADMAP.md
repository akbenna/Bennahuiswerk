...
- **Per-kind accounts (scores volgen het kind, niet het toestel):** elk kind logt op elk toestel in met **zijn naam + wachtwoord (standaard "Bennaclan")**. Zijn scores staan online op zijn eigen account, dus op elk toestel gelijk. Bij inloggen worden lokale en online scores **samengevoegd** (geen verlies); wijzigingen worden automatisch teruggezet. Werkt ook offline (dan met het lokale wachtwoord) en synct daarna. De ouder kan alle accounts in één klik online zetten.
