...
with verwacht (functie, uit_bestand, md5_repo) as (
  values
    ...
    ('kal_coach_bouwen', '06-de-coach-prikkelt.sql', 'b497686b36de46b6ed512355f776d9b5'),
    ('kal_coach_stand', '06-de-coach-prikkelt.sql', '9bd4b0e1cf8950cb392ed9fae0ceabe7'),
    ('kal_dagen_importeren', '42-beweegminuten-uit-een-schermafdruk.sql', '05af439cd4eb591c0f0aff80ee32c186'),
    ('kal_eiwitrijk', '38-een-getal-dat-niet-kan-bestaan.sql', 'da67ff29517e540dd2c2e20abf789bfa'),
    ('kal_gerecht', '01-bibliotheek-en-portiematen.sql', '18f73b7f512af03a10af561ccbd0ae90'),
    ...
    ('kal_nevo_zoek', '22-benaderen-mag-alleen-op-een-naam.sql', '16022319f990c6f09d21a7ae053eff24'),
    ...
    ('kal_proef_koppeling', '03-proef-koppeling.sql', '2c3860d35f55b2f1907d1523181ba489'),
    ...
    ('kal_ww_klacht', '39-een-wachtwoord-dat-standhoudt.sql', 'efc154e780a964c2ade77daac5eea9f0'),
    ...
    ('kal_zoeken', '30-natrium-in-het-zoeken.sql', '171744fe829ccf08e5afcb778f258d6b')
),
in_de_database as (
