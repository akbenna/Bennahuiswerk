...
with verwacht (functie, uit_bestand, md5_repo) as (
  values
    ...
    ('kal_ai_toegestaan', '48-een-wachtkamer-en-een-budget.sql', '078db8ca318519b471d8fd7ccf019112'),
    ...
    ('kal_mijn_toegang', '48-een-wachtkamer-en-een-budget.sql', '1e7b60ea18867473bdd33584cfaf6ba3'),
    ...
    ('kal_tester_zetten', '48-een-wachtkamer-en-een-budget.sql', 'b97c31b5237533ad89eeab1160313d00'),
    ('kal_testers', '48-een-wachtkamer-en-een-budget.sql', '7085184d662f82747ef9cb9f8def48e8'),
