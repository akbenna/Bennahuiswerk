...
with verwacht (functie, uit_bestand, md5_repo) as (
  values
    ...
    ('kal_account_wissen', '53-de-verwijderknop-die-op-een-kolom-wachtte.sql', '162e6109a6392056af294af4032cde3f'),
    ('kal_afmelden', '50-de-negen-die-er-nog-niet-stonden.sql', '18fee428b7eca1cc723cc424d8b44391'),
    ('kal_ai_toegestaan', '49-een-eigen-sleutel-buiten-de-database-om.sql', 'e02352d452df50632478acbc6579ff3c'),
    ...
    ('kal_dagstand', '50-de-negen-die-er-nog-niet-stonden.sql', 'd858035bb576757e0fc9adbc1345f4a9'),
    ...
    ('kal_mijn_toegang', '49-een-eigen-sleutel-buiten-de-database-om.sql', 'ba819eae123e3e444b14c5f4e43605db'),
    ...
    ('kal_prikkel_bouwen', '51-het-slot-dat-een-scherm-was.sql', '7c7ce4d917afed2814f37f6ccec4c193'),
    ...
    ('kal_profiel_zetten', '50-de-negen-die-er-nog-niet-stonden.sql', '742023cfc686a81e0d1c0e539e9f81cf'),
    ('kal_regel_wissen', '50-de-negen-die-er-nog-niet-stonden.sql', '66f3be2cfd7aba7b92ee60e053d1d01c'),
    ('kal_regels_toevoegen', '50-de-negen-die-er-nog-niet-stonden.sql', '3d8efe4dc022037a876011ae4fc5b514'),
    ...
    ('kal_sleutel_opbergen', '49-een-eigen-sleutel-buiten-de-database-om.sql', 'a46c538a73c68498ab3ca5290e8cf256'),
    ('kal_sleutel_voor', '49-een-eigen-sleutel-buiten-de-database-om.sql', '3ea1ab5256e6254cccc75db87b648bf2'),
    ('kal_sleutel_weg', '49-een-eigen-sleutel-buiten-de-database-om.sql', 'cb088ad522f99a62f3964a551586ed17'),
    ('kal_sleutel_weghalen', '49-een-eigen-sleutel-buiten-de-database-om.sql', '3055de9d01c03c5e62d4868ea59c5452'),
    ...
    ('kal_testers', '49-een-eigen-sleutel-buiten-de-database-om.sql', '403c7313b2e9ca970dfeb93e72fcf648'),
    ('kal_verzadiging', '37-fijner-dan-een-groep.sql', '06d1cccc04c19755174d281a789020e8'),
    ('kal_weekcijfers', '50-de-negen-die-er-nog-niet-stonden.sql', '9c50df447ba4c42ecaf14ea5a6a9ab64'),
